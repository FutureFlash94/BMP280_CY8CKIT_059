// ======================================================================
// BMP280_CY8CKIT_059.v generated from TopDesign.cysch
// 11/26/2021 at 10:40
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("aebd1c44-8d23-413c-92af-251f5ba1ba6c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ff67644d-f9b8-4858-af2a-b7ceb765e501"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9ac44954-25c7-4792-9f06-dd28ac4abcee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [1:0] tmpOE__Pin_2_net;
	wire [1:0] tmpFB_1__Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2_net;
	electrical [0:0] tmpSIOVREF__Pin_2_net;

	cy_psoc3_pins_v1_10
		#(.id("3008a664-3b5f-4e62-909b-37270b037897"),
	...
	assign tmpOE__Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
