...
{
   #if(TIMER_1MS_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(TIMER_1MS_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG32(TIMER_1MS_PERIOD_LSB_PTR));
   #endif /* (TIMER_1MS_UsingFixedFunction) */
}
...
void TIMER_1MS_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG32(TIMER_1MS_PERIOD_LSB_PTR, period);
...
{
   #if(TIMER_1MS_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(TIMER_1MS_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG32(TIMER_1MS_CAPTURE_LSB_PTR));
   #endif /* (TIMER_1MS_UsingFixedFunction) */
}
...
void TIMER_1MS_WriteCounter(uint32 counter) 
{
    ...
    #else
        CY_SET_REG32(TIMER_1MS_COUNTER_LSB_PTR, counter);
